...
public class GetEventActivity extends BaseAction {
  ...
  public Optional<Iterable<OperationDetails>> get(String stringifiedEventUuid, String filter, int page) {
    ...
    final ExecutionResult<Iterable<OperationDetails>> result = searchBus.sendAndWaitResponse(
